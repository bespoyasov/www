export const metadata = {
  ...
  description:
    "В ES2017 появились асинхронные функции, которые позволяют сделать асинхронные вызовы более плоскими и похожими на синхронные. На первый взгляд в них есть проблемы с обработкой ошибок, но их можно обойти.",
  datetime: "2018-05-17T21:00",
  tags: ["dev", "advice", "favorite"],
