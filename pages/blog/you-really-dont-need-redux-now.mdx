...
export const metadata = {
  ...
  description:
    "В Реакте в версии 16.7.0-alpha появились хуки. Это АПИ, которое позволяет использовать локальный стейт без использования классов. И среди них есть один, который, как мне кажется, может заменить собой Редакс.",
  datetime: "2018-11-15T10:00",
  tags: ["Dev", "Tools", "Learning", "Editorial"],
...
<Picture
  src="/img/notes/no-redux-prop-drilling.jpg"
...
![Приложение для примера](/img/notes/no-redux-1.jpg)
...
![Структура вложенности компонентов](/img/notes/no-redux-2.jpg)
