...
![Схема работы Пульса](./pulse-scheme.webp)
...
![Карта паттернов восстановления от ошибок](./recover-patterns.webp)
...
![Структура отказоустойчивой системы](./system-structure.webp)
