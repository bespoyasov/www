...
![На каждом уровне у нас только необходимое количество деталей, причём — только тех, что важны на текущем уровне погружения в систему](./02-fractal-architecture.webp)
