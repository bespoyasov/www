...
![Services are not directly tied to a specific application, they can be reused in different projects with the help of adapters](./04-services-and-adapters.webp)
