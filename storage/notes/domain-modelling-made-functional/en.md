...
![When converting the real world into a model, details can get lost, that's normal](./real-model.webp)
...
![A class diagram that you can (but don't need to) build](./class-diagram.webp)
