...
<Highlight>(Sample size) = (Number of tokens in the key) + 1</Highlight>
...
![Note about software design and application layers](/images/content/text-generation-with-markov-chains/en/article-example-2.png)

Something about objects and testing...

![Note about testing callbacks](/images/content/text-generation-with-markov-chains/en/article-example-3.png)
