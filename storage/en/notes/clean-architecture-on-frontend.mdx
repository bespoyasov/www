...
Now that we've talked about theory, we can get down to practice. Let's design the architecture of a [cookie store](https://bespoyasov.ru/showcase/frontend-clean-architecture/en/).
