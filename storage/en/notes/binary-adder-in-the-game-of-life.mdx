...
As a result, we're going to create an [app](https://bespoyasov.ru/showcase/game-of-life/) that takes 2 two-bit numbers and visualizes signals traveling to calculate the answer.
...
- [Sample App](https://bespoyasov.ru/showcase/game-of-life/)
