...
cover: /images/content/my-week-at-jsunderhood/oop-vs-fp.png
tags:
  - opinion
  - process
  - architecture
...
<Highlight>
  Architecture, like a screwdriver, costs resources. Supporting a complex spaghetti-code project,
  like arthritis—also costs resources, and also tends to be more
</Highlight>
...
<Highlight>The costs of the tool should be less than the benefits</Highlight>
...
<Highlight>Start with the domain</Highlight>
...
![For me shitposting about OOP vs FP looks like this meme](/images/content/my-week-at-jsunderhood/oop-vs-fp.png)
...
<Highlight>
  We should, on the contrary, assemble the complex from the simple—use the composition
</Highlight>
...
<Highlight>
  And also (the hardest thing for me) we have to stop perfectionism when refactoring
</Highlight>
...
**2. Use the blog as a notebook**. I try to [summarize the books](/tag/books/) I read so I can get a better grasp on the subject. If I need to go back to a book later, I go back to the outline first. If it has what I was looking for—great, if not, that's an excuse to reread the book and supplement the outline.
