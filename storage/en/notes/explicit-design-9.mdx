...
![With each new feature, the converter has to add a new adapter and update the use case to send a signal to each of them](/images/content/explicit-design-series/09-multiple-adapters.png)
...
![Use case sends only one signal to the external world, to which other features react autonomously](/images/content/explicit-design-series/09-decoupling-via-events.png)
