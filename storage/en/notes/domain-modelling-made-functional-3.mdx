...
<Switch options={['fs', 'ts']} id="place-order">
...
<Switch options={['fs', 'ts']} id="validate-order">
...
<Switch options={['fs', 'ts']} id="check-address-exists">
...
<Switch options={['fs', 'ts']} id="validate-order-function">
...
<Switch options={['fs', 'ts']} id="to-customer-info">
...
<Switch options={['fs', 'ts']} id="to-address">
...
<Switch options={['fs', 'ts']} id="helpers">
...
<Switch options={['fs', 'ts']} id="to-validated-order-line">
...
<Switch options={['fs', 'ts']} id="check-address-exists-dependency">
...
<Switch options={['fs', 'ts']} id="place-order-error">
...
<Switch options={['fs', 'ts']} id="domain-types">
...
<Switch options={['fs', 'ts']} id="working-with-dto">
...
<Switch options={['fs', 'ts']} id="crud-in-types">
