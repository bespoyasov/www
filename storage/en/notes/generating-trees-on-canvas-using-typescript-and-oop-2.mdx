...
![Diagram of the public API and module dependencies](/images/content/generating-trees-on-canvas-using-typescript-and-oop-2/drawer-interface.png)
...
![Provider component diagram](/images/content/generating-trees-on-canvas-using-typescript-and-oop-2/context-provider.png)
...
![The dependencies of each module are the input interfaces of the other](/images/content/generating-trees-on-canvas-using-typescript-and-oop-2/graphics-diagram.png)
...
![The result in the browser](/images/content/generating-trees-on-canvas-using-typescript-and-oop-2/canvas-result.png)
...
- [Application](https://bespoyasov.ru/showcase/treees/)
