...
<Highlight>Tools shouldn't dictate anything to you at all</Highlight>
...
<Highlight>Business rules are the skeleton around which everything else is wrapped</Highlight>
...
<Highlight>It all depends on business rules. Design you architecture based on them</Highlight>
